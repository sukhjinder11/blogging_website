...
urlpatterns= [
    ...
    path(r'^post/(?P<pk>\d+)/edit/$',views.UpdatePostView.as_view(),name='post_edit'),
    path(r'^post/(?P<pk>\d+)/remove/$',views.DeletePostView.as_view(),name='post_remove'),
    ...
    path(r'^comment/(?P<pk>\d+)/remove/$',views.comment_delete,name='comment_remove'),
